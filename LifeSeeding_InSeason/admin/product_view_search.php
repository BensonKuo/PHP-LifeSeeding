...
<a href="product_view.php"><button class="pure-button button-success">瀏覽所有商品</button></a>
<br><br>
...
$result = mysql_query("SELECT * FROM product WHERE Name='".$_POST['search']."' OR Author='".$_POST['search']."'; ",$link);
?>
