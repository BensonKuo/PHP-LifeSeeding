...
<div id='main'>
    ...
    <div class='content'> 
        ...
        <h3></h3>
        <!--表單-->
        <form class="pure-form pure-form-stacked" action='paymentconfirm_view.php' method='POST'>
            <fieldset>
                <legend>匯款資訊回報</legend>

                <div class="pure-g">
                    <div class="pure-u-1 pure-u-md-1-2">
                        <label for="first-name">購買人姓名</label>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <input id="phone" name='Phone' class="pure-u-23-24 pure-u-md-18-24" type="text" required placeholder="e.g, 0912345678">
                    </div>

                    <div class="pure-u-1 pure-u-md-1-2">
                        <label for="a">匯款帳號後五碼</label>
                        <input id="a" name='transferAcc' class="pure-u-23-24 pure-u-md-18-24" type="text" required placeholder="e.g, 12345">
                    </div>

                    <div class="pure-u-1 pure-u-md-1-2">
                        <label for="v">匯款金額</label>
                        <input id="v" name='transferAmt' class="pure-u-23-24 pure-u-md-18-24" type="text" required placeholder="e.g, 500">
                    </div>

                    <div class="pure-u-1">
                        <label for="t">約略匯款時間</label>
                        <input id="t" name='transferTime' class="pure-u-23-24 pure-u-md-9-24" type="text" required placeholder="e.g, 05.27 14:35">
                    </div>
                    ...
                    <button type="submit" class="pure-button pure-button-primary button-blue">下一步</button>
            </fieldset>
        </form>
