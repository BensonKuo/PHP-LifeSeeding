...
<div id='main'>
    ...
    <div class='content'> 
        ...
        <!--表單-->
        <form class="pure-form pure-form-stacked" action='checkout_exe.php' method='POST'>
            <fieldset>
                <legend>訂購人資訊</legend>
                ...
                <div class="pure-g">
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <input id="last-name" name='CustomerFrom' class="pure-u-23-24 pure-u-md-18-24" type="text" required placeholder="系級(非本校生請填校外)">
                    </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <input id="email" name='Email' class="pure-u-23-24 pure-u-md-18-24" type="email" required placeholder="Email">
                    </div>

                    <div class="pure-u-1 pure-u-md-1-2">
                        <label for="city">Note</label>
                        <input id="city" name='Note' class="pure-u-23-24 pure-u-md-18-24" type="text" placeholder="備註">
                        <br>
                    </div>


                    <div class='pure-u-1'>
                         <?php include('checkoutlist.php'); ?>
                         <br>
                    </div>
     
                    <button type="submit" class="pure-button pure-button-primary">送出訂單！</button>
            </fieldset>
        </form>
